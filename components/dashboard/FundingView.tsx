...
export default function FundingView() {
  ...
  const handleSupportSubmit = async () => {
    if (isTeamMember || !activeProfile) return; // founder only — sets payout bank details
      ...
      <div style={styles.page}>
        <div style={styles.successCard}>
          ...
          <p style={styles.successText}>
            We've received the funding application for{" "}
            <strong>{activeProfile.startup_name}</strong>. Our team will review it
            and get back within 3 to 5 business days.
          </p>
          <div style={styles.successDetails}>
            <div style={styles.successDetailRow}>
              <span style={styles.successDetailLabel}>Profile</span>
              <span style={styles.successDetailValue}>xeero.me/{activeProfile.slug}</span>
            </div>
            <div style={styles.successDetailRow}>
          ...
          <button style={styles.successBtn} onClick={() => router.push(isTeamMember ? "/team-dashboard" : "/dashboard")}>
            Back to Dashboard
          </button>
        </div>
      </div>
          ...
          <div>
            ...
            {status === "approved" && (
              <p style={styles.statusSub}>
                This profile now accepts community support. Supporters can find the button on the public page.
              </p>
            )}
            {status === "pending" && (
              <p style={styles.statusSub}>
                Under review. Should hear back within 2 to 3 business days.
              </p>
            )}
            {status === "declined" && (
              <p style={styles.statusSub}>
                This application was not approved. Can reapply after 30 days.
              </p>
            )}
          </div>
        </div>
      ...
      return (
        <div style={{ ...styles.statusBadge, backgroundColor: "#fffbeb", border: "1px solid #fef08a" }}>
          ...
          <div>
            ...
            <p style={styles.statusSub}>
              Will be reviewed within 2 to 3 business days.
            </p>
          </div>
        </div>
      );
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        ...
        <div>
          ...
          <p style={styles.headerSub}>Submit this startup for review by our investor network</p>
        </div>
      </div>
      ...
      <div style={styles.profilePill}>
        ...
        <span style={styles.profilePillText}>
          Applying as <strong>xeero.me/{activeProfile.slug}</strong>
        </span>
      ...
      <div style={styles.form}>
        <div style={styles.card}>
          ...
          <p style={styles.cardSubtitle}>Tell us about the raise.</p>
          ...
          <textarea
            ...
            placeholder="What will this funding be used for? Be specific."
            value={useOfFunds}
        ...
        <div style={styles.infoCard}>
          ...
          <div style={styles.infoSteps}>
            {[
              "We review the Xeero profile and application.",
              "If it's a fit, we connect with relevant investors in our network.",
              "An email follows within 3 to 5 business days.",
            ].map((step, i) => (
        ...
        <p style={styles.disclaimer}>
          By submitting, you confirm this profile is accurate and authorised to raise on behalf of this startup.
        </p>

        {/* ── Community Support — founder only ── */}
        {!isTeamMember && (
          <>
            ...
            <div style={styles.supportHeader}>
              ...
              <div>
                ...
                <p style={styles.headerSub}>
                  Let visitors support this startup directly from the profile
                </p>
              </div>
            </div>
            ...
            {!existingApplication && !supportSubmitted && (
              <div style={styles.card}>
                ...
                <p style={styles.cardSubtitle}>
                  Where should supporter payments go? We need a Nigerian bank account to set up the Paystack wallet.
                </p>
                ...
                <button
                  style={{ ...styles.submitBtn, opacity: supportSubmitting ? 0.6 : 1, marginTop: "4px" }}
                ...
                <p style={styles.disclaimer}>
                  Bank details are used only to receive supporter payments via Paystack. Card details are never stored.
                </p>
              </div>
            )}
          </>
